...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::remote_pipe_info,
            commands::remote_poll_state,
            ...
            commands::remote_set_rfi,
            commands::remote_request_rfi,
            commands::remote_set_hevc,
