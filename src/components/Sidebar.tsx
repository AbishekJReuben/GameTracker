...
import { LayoutDashboard, Library, CalendarRange, Trophy, Settings, Gamepad2, Tag, Compass, AppWindow, Cpu, Headphones, Smartphone, NotebookPen, Send } from "lucide-react";
...
const NAV = [
  ...
  { to: "/clipboard", label: "Notes", icon: NotebookPen },
